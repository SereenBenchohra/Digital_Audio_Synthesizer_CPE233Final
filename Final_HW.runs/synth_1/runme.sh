...
HD_PWD='D:/Cal Poly/S19/CPE 233/Vivado/Final_HW/Final_HW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RatWrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RatWrapper.tcl
