...
HD_PWD='D:/Cal Poly/S19/CPE 233/Vivado/Final_HW/Final_HW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RatWrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RatWrapper.tcl -notrace
